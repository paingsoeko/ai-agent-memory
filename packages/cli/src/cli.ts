      ...
      case "embed": {
        ...
        if (!engine.embeddings)
          throw new MemoryError(
            ...
            'Set embeddings.provider to "hash" (local) or install @local-ai-agent-memory/embeddings for more.',
          );
      ...
      case "mcp": {
        ...
        out(snippet, () =>
          [
            ...
            "  npx -y @local-ai-agent-memory/mcp            # or: ai-memory-mcp",
            "",
            "Claude Code:   claude mcp add ai-memory -- npx -y @local-ai-agent-memory/mcp",
