...
export default defineConfig({
  resolve: {
    alias: {
      "@ai-agent-memory/core": r("./packages/core/src/index.ts"),
      ...
      "@ai-agent-memory/adapter-opencode": r("./packages/adapters/opencode/src/index.ts"),
      "@ai-agent-memory/adapter-openrouter": r("./packages/adapters/openrouter/src/index.ts"),
    },
  },
  test: {
